...
class _AccessWidgetState extends State<AccessWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await actions.getPageParamas(
        'code',
        'scope',
      );
      await UsersTable().update(
        data: {
          'authorization_code': FFAppState().authCode,
        },
      ...
      await actions.getTokens(
        FFAppState().authCode,
      );
      await UsersTable().update(
        data: {
          'access_token': FFAppState().accessToken,
          'refresh_token': FFAppState().refreshToken,
        },
        matchingRows: (rows) => rows.eq(
          'id',
          currentUserUid,
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> accessUsersRowList = snapshot.data!;

        final accessUsersRow =
            accessUsersRowList.isNotEmpty ? accessUsersRowList.first : null;
                                      ...
                                      if (responsiveVisibility(
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await launchURL(
                                                  'https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/gmail.readonly&access_type=offline&include_granted_scopes=true&response_type=code&redirect_uri=https://tomoaimvp-app-3sa6fr.flutterflow.app/integrations&client_id=425172227831-rndnqvi3438askt7s5e4g62f5i2q8sp6.apps.googleusercontent.com');
                                            },
                                            text: 'Connect',
