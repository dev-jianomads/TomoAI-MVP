...
import '/components/chat_bubbles2/chat_bubbles2_widget.dart';
...
import 'tomochat_model.dart';
export 'tomochat_model.dart';

class TomochatWidget extends StatefulWidget {
  const TomochatWidget({
    super.key,
    required this.tasks,
    required this.email,
  ...
  static String routeName = 'tomochat';
  static String routePath = '/tomochat';

  @override
  State<TomochatWidget> createState() => _TomochatWidgetState();
}

class _TomochatWidgetState extends State<TomochatWidget>
    with TickerProviderStateMixin {
  late TomochatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TomochatModel());
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemCount:
                                                  conversationItem.length,
                                              itemBuilder: (context,
                                                  conversationItemIndex) {
                                                final conversationItemItem =
                                                    conversationItem[
                                                        conversationItemIndex];
                                                return ChatBubbles2Widget(
                                                  key: Key(
                                                      'Keycs8_${conversationItemIndex}_of_${conversationItem.length}'),
                                                  conversation:
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                // Add user chat to supabase
                                                _model.userConversationResult =
                                                    await ConversationTable()
                                                        .insert({
                                                ...
                                                _model.addToConversation(_model
                                                    .userConversationResult!);
                                                safeSetState(() {});
                                                // LF API
                                                _model.lfChatResponse =
                                                    await LangflowAPIGroup
                                                        .chatCompletionCall
                                                        .call(
                                                  message: _model
                                                ...
                                                // Add assistant chat to supabase
                                                ...
                                                // Add assistant chat to history
                                                _model.addToConversation(_model
                                                    .latestSystemChatResult!);
                                                safeSetState(() {});
                                                // Add session_Id to chat
